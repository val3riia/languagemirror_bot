...
class OpenRouterClient:
    ...
    This is a compatibility wrapper that works with OpenRouter
    and has a similar interface to OpenAI API.
    
    For use with this client, you need to set OPENROUTER_API_KEY
    ...
    def __init__(self):
        ...
        # GPT-4o mini provides good quality at reasonable cost
    ...
    def get_completion(self, system_message: str, messages: List[Dict[str, str]]) -> str:
        ...
        """
        if not self.api_key:
            return "API key not configured. Please set OPENROUTER_API_KEY in your environment variables."
        
        headers = {
            "Authorization": f"Bearer {self.api_key}",
            "Content-Type": "application/json",
            "HTTP-Referer": "https://language-mirror-bot.replit.app"  # Replace with your site's domain
        }
